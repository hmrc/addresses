...
See [the UK address schema (v1)](uk-address-object.json) and address [example 1](uk-address-object-sample1.json).
Suitable Scala case classes are available in
[address-reputation-store](https://github.com/hmrc/address-reputation-store/tree/master/src/main/scala/uk/gov/hmrc/address/v1).
...
URL:
 ...
 - `{contextPath}/uk/addresses/nnnnnnnnnn`
 - `{contextPath}/gb/addresses/nnnnnnnnnn` (alias for `uk`)

Example URLs:

 - `{contextPath}/uk/addresses/GB1234512345`
...
Response:
 ...
 - The body will be a _JSON object_ containing *one* [UK Address Object (v1)](uk-address-object.json).
     [Example response (v1)](uk-address-object-sample1.json)
...
[UK Address Objects (v1)](uk-address-object.json). [Example response (v1)](address-response-sample1.json)
...
URL:
 ...
 - `{contextPath}/uk/addresses`
 - `{contextPath}/gb/addresses` (alias for `uk`)

Example URL:

 - `{contextPath}/uk/addresses?uprn=1234512345`
...
Response:
 ...
 - `Content-Type: application/json`
 - Expiry and cache control headers will be set appropriately.
 - The body will be a _JSON array_ containing *zero or more* [UK Address Objects (v1)](uk-address-object.json).
     [Example response (v1)](address-response-sample1.json)
...
URL:
 ...
 - `{contextPath}/uk/addresses`
 - `{contextPath}/gb/addresses` (alias for `uk`)
 - `{contextPath}/v1/uk/addresses.json` (old style - deprecated)

Example URL:

 - `{contextPath}/uk/addresses?postcode=AA1+1ZZ&filter=The+Rectory`
